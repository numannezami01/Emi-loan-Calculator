...
export default function BusinesLoan({
  ...
  const handletimessChange = (event) => {
          ...
          <div style={{ padding: "20px", marginTop: "70px" }}>
            ...
            >
              <Typography variant="h5" textAlign="left" color={"#621BEC"}>
                Bussiness Loan EMI Calculator
              </Typography>
            </Box>
            <br />

            <Typography fontSize={13} color={"gray"}>
              Fast Credit's Business Loan EMI Calculator is a reliable tool for
            ...
            <Grid container spacing={2}>
              <Grid item md={6} xs={12}>
                ...
                <TextField
                  ...
                  onBlur={handleBlur}
                  InputProps={{
                    endAdornment: <Typography variant="span">₹</Typography>,
                  }}
                  margin="normal"
                />
                <br />
